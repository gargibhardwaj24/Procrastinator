  ...
  return (
    <>
      ...
      <div className="pt-5" style={{ backgroundColor: 'beige', height: screen.height }}>
        ...
        <div className="tasks bg-green-600/20 m-3 w-5xl rounded-xl px-5">
            ...
            {todos.map(item => {
              ...
              return <div key={item.id} className="todo flex justify-between items-center">
                ...
                <div className="buttons flex justify-center items-center">
                  ...
                  />
                  <button onClick={handleEdit} className='p-2 bg-green-950/75 m-2 rounded-xl hover:cursor-pointer'>edit</button>
